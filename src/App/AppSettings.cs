...
public sealed class AppSettings
{
    ...
    /// Под какое разрешение клиента подгонять окно: "auto" — считать с самого
    /// клиента, иначе одно из значений его настроек (1024/1280/1600/1920).
    /// Клиент на 1024×576 занимает четверть экрана, и оверлей «под 1920» рядом с
    /// ним выглядит громадным — масштаб должен идти за клиентом.
    public string ClientSize { get; set; } = "auto";
